        ...
        <header className="md:hidden flex items-center justify-between bg-white border-b border-gray-200 h-16 px-4 fixed top-0 w-full z-30 shadow-sm">
            <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-emerald-600 font-semibold tracking-tight">Bhavnagar</span>
                </div>
            </div>
            
            <button
                onClick={onMenuOpen}
                className="p-2 -mr-2 text-gray-500 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded-md"
