            ...
            <div id="print-area" className="print-only">
                <div className="printable-container text-black bg-white" contentEditable suppressContentEditableWarning style={{ outline: "none", fontFamily: 'Cambria, Georgia, serif', fontSize: '14px', lineHeight: '1.5', padding: '40px 60px', color: '#000', boxSizing: 'border-box' }}>
                    ...
                    <div style={{ textAlign: 'justify', textIndent: '3em', marginBottom: '8px', fontSize: '14px', lineHeight: '1.5' }}>
                        This is to notify you that your Bid dated {formatDateToOutput(tender.tenderCreationDate)} for execution of the <span style={{ fontWeight: 'bold' }}>{packageData.packageName || tender.packageName}</span>, Tender ID- <span style={{ fontWeight: 'bold' }}>{tender.tenderId}</span> for the Contract Price of <span style={{ fontWeight: 'bold' }}>Rs.{(tender.contractPrice || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span> ({tender.aboveBelowPercentage?.toFixed(2)} % {tender.aboveBelowInWord}) (<span style={{ fontWeight: 'bold' }}>{numberToIndianWords(tender.contractPrice || 0)}</span>) as corrected and modified in accordance with the Instructions to Bidders is hereby accepted by our agency.
                    </div>
                    ...
                    <div style={{ fontSize: '12px', lineHeight: '1.4' }}>
                        ...
                        <ul style={{ listStyleType: 'decimal', paddingLeft: '20px', margin: '2px 0 0 0' }}>
                            ...
                            <li>Deputy Executive Engineer, Panchayat R & B Sub Division, {packageData.subDivision || tender.taluka || 'Bhavnagar'}</li>
                            <li>Office Copy.</li>
                        </ul>
                    </div>
                </div>
