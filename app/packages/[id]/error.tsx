  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-md w-full text-center space-y-4">
        ...
        <div>
          <h2 className="text-lg font-bold text-slate-800">Error Loading Package</h2>
          <p className="text-xs text-slate-500 mt-1">
            {error?.message || 'An unexpected error occurred while loading this package.'}
          </p>
        </div>
        <div className="pt-2 flex justify-center gap-3">
          ...
          <Link
            href="/packages"
            className="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-semibold shadow-xs transition-colors cursor-pointer"
          >
            Back to Packages
          </Link>
        </div>
